...
public class EmailServiceImpl implements IEmailService {
	 ...
	 */
	@Override
	public Boolean sendEmailWithTemplateToUser(Optional<EmailTemplate> emailTemplate, String associatedApi,
			String email, String uuid, String emailSender, String emailRedirectUrl) {
		try {
			emailTemplate.get().setContent(this.replaceTemplateContent(associatedApi, emailTemplate.get().getContent(),
					emailRedirectUrl, uuid));
